...
async getExchangeRate(){
    try{
    const res1 =  await fetch('https://api.exchangeratesapi.io/latest?base=GBP&symbols=INR');
    const res2 =  await fetch('http://worldclockapi.com/api/json/est/now');
        const blocks1 =  await res1.json();
        const blocks2 =  await res2.json();
        const tempExch = Math.round(blocks1.rates.INR*100)/100;
        const time = blocks2.currentDateTime;
        console.log(time);

        this.setState({
            currentExchangeRate:tempExch,
            timeNow:time,
        })
            ...
            <Aux>
                            ...
                            <Card.Body className='border-bottom'>
                                <div className="row align-items-center justify-content-center">
                                    <div className="col-auto">
                                        <i className="fa fa-thumbs-up text-c-blue f-36"/>
                                    </div>
                                    <div className="text-right">
                                        <h3>8 Projects</h3>
                                        <h5 className="text-c-green mb-0">+7.2% </h5><span className="text-muted">From Previous</span>
                ...
                <Row>
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Projects with more than 90% Pass rates</h6>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Projects with less than 90% Pass rates</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                    ...
                    <Col xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Projects with no runs recently</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                    ...
                    <Col md={6} xl={4}>
                        <Card className='card-event'>
                            <Card.Body>
                                <div className="row align-items-center justify-content-center">
                                    <div className="col">
                                        <h5 className="m-0">Live Pound Rate</h5>
                                    </div>
                                    <div className="col-auto">
                                        <label className="label theme-bg2 text-white f-14 f-w-400 float-right">34%</label>
                                    </div>
                                </div>
                                <h2 className="mt-2 f-w-300">{this.state.currentExchangeRate}<sub className="text-muted f-14"> ₹ for 1 GBP</sub></h2>
                        ...
                        <Card>
                            <Card.Body className='border-bottom'>
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col">
                                        <h3 className="f-w-300">{this.state.timeNow}</h3>
                                        <h3 className="f-w-300">{this.state.testName}</h3>
